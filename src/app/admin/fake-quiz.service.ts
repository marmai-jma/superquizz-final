/**
 * @file
 * ATTENTION. This is the same code as quiz.service.ts.
 * The only reason I have duplicated the original service
 * is to make the AdminModule functional *BEFORE*
 * the QuizService has been developed by the participants.
 */
